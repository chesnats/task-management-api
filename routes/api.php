...
Route::middleware('check.role')->group(function () {
    ...
    // Teams Export/Import
    Route::get('export/teams',  [TeamController::class, 'export'])->middleware('check.role:Admin');
    Route::post('import/teams', [TeamController::class, 'import'])->middleware('check.role:Admin');
});
